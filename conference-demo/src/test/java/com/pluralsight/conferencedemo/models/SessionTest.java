...
public class SessionTest {
    ...
    public void testJpaStartsWith() throws Exception {
        List<Session> sessions = jpaRepository.findBySessionNameStartsWith("Getting");
        assertTrue(sessions.size() > 0);
    }

    @Test
    public void testJpaEndsWith() throws Exception {
        List<Session> sessions = jpaRepository.findBySessionNameEndsWith("AWS");
        assertTrue(sessions.size() > 0);
    }
